...
#undef yyFlexLexer
#define yyFlexLexer Masihini_FlexLexer // the trick with prefix; no namespace here :(
#include <FlexLexer.h>
#endif
...
#undef YY_DECL
#define YY_DECL Masihini::Parser::symbol_type Masihini::Scanner::get_next_token()
...
public:
	...
	virtual ~Scanner() {}
	virtual Masihini::Parser::symbol_type get_next_token();
